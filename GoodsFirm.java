...
public class GoodsFirm extends Firm{
	...
	GoodsFirm(ContinuousSpace<Object> space, Grid<Object> grid, int ID, GoodsSector ownSector,int bankID, int clearingHouseID){
	...
	public void outputDelivery() {
		...
		if(this.ownSector.sectorID==2) {	
			...
			System.out.println("outputCapital	 "+outputCapital+"outputIntermediate	"+ outputIntermediate + "	outputLabor	"+outputLabor+"	outputIntermediate	"+outputIntermediate+"	outputService	"+outputService+"	outputEnergy	"+outputEnergy);
		}
	}
